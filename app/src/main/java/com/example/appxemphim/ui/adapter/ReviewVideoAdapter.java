...
public class ReviewVideoAdapter extends RecyclerView.Adapter<ReviewVideoAdapter.MyViewHolder>{

    private Context context;
    private List<YoutubeVideoItem> listVideos;

    public ReviewVideoAdapter(Context context, List<YoutubeVideoItem> listVideos){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context)
                .inflate(R.layout.item_recycler_view_review_video, parent,false));
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Log.i("LOAD", "MyViewHolder");
