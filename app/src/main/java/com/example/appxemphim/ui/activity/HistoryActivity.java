...
public class HistoryActivity extends AppCompatActivity implements HistoryAllAdapter.OnDeleteItemClickListener{
    private int userId;
        ...
        call.enqueue(new Callback<List<History>>() {
            ...
            public void onResponse(Call<List<History>> call, Response<List<History>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    RecyclerView recyclerView = findViewById(R.id.recycler_view_items);
                    historyAllAdapter = new HistoryAllAdapter(HistoryActivity.this, movies);
                    historyAllAdapter.setOnDeleteItemClickListener(HistoryActivity.this);
